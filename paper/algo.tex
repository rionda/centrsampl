...
u}\sum_{p\in\mathcal{S}_{v_iw}}\frac{\mathds{1}_p(u)}{|\mathcal{S}_{v_iw}|},
\]
...
\[ 
X_i=n\sum_{w\neq v_i,w\neq
u}\sum_{p\in\mathcal{S}_{v_iw}}\frac{\mathds{1}_p(u)}{|\mathcal{S}_{v_iw}|}\enspace
.
\]
...
u}\sum_{p\in\mathcal{S}_{v_iw}}\frac{\mathds{1}_p(u)}{|\mathcal{S}_{v_iw}|}\right]
=\frac{n}{k}\sum_{v\in V}\mathbf{E}\left[Y_v\sum_{w\neq v,w\neq
u}\sum_{p\in\mathcal{S}_{vw}}\frac{\mathds{1}_p(u)}{|\mathcal{S}_{vw}|}\right] =
\\
&=\frac{n}{k}\sum_{v\in V}\mathbf{E}[Y_v]\sum_{w\neq v,w\neq
u}\sum_{p\in\mathcal{S}_{vw}}\frac{\mathds{1}_p(u)}{|\mathcal{S}_{vw}|}
