...
\XXX Not sure about the correctness of the following. \MR For our case, a
$2$-approximation to $\Delta_G$ is sufficient and can be computed in time \XXX
by selecting a vertex $v\in V$ uniformly at random, computing the shortest paths
from $v$ to all other vertices in $V$, and taking $\tilde\Delta_G$ to be the sum
of the sizes of the two longest shortest paths from $u$ to two distinct other
nodes. 
...
\end{lemma}
\begin{proof}
  \XXX Right not I'm not sure this is true\ldots \MR
\end{proof}
