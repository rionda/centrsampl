...
definitions and results and refer the reader to the book of~\citet{MohriRT12}
...
not depend on $|D|$ or on $|\range|$ neither does the sample size. This will
make our algorithms scale well as the size of the network increases.
