...
\XXX The bound presented in Lemma~\ref{lem:vcdimuppbound} is strict in the sense that
...
\begin{IEEEproof}
  TBD Remember to take care of the cases $d=1,2$.
\end{IEEEproof}
...
see that $\VC(\range_G^{\mathrm{p},k})$ is still at most $\lfloor\log_2(k-1)+1$
