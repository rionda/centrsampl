...
for the top-$K$ vertices offers a \emph{multiplicative}, i.e., stricter,
guarantee. We delve more in the comparisons with these algorithms in
...
\citet{MaiyaBW10} use concepts from expander
