...
\fi
  ...
  proving upper and lower bounds [to][ EK: Is it "to" or "of"? If it is of, it should be fixed in the
  entire document] the VC-dimension of a range set associated
  ...
  quantity [that we call the][ EK: "namely"?] vertex-diameter, that is the maximum number of
