\begin{abstract}
  ...
  these cases. 
  We present two efficient randomized approximation algorithms for betweenness
  ...
  $1-\delta$. This is the first algorithm that reaches such approximation for
  the top-K vertices. We use results from the VC-dimension theory to develop
  bounds to the sample size needed to obtain the desired approximations. By
  proving upper and lower bounds to the VC-dimension of a range set associated
  to the problem at hand, we obtain a sample size that is independent from the
